...
export function fetchInteractionBasedRecommendation() {
    return axios.get(`/activity-recommendations/interaction`);
}

export function fetchActivityBasedRecommendation(){
    return axios.get(`/activity-recommendations`)
}
export function fetchActivityBasedRecommendationML(){
    return axios.get(`/activity-recommendations/ml`)
}
