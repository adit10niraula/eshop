...
const OrderSuccessPage = () => {
    ...
    return (
        <>
          ...
          <div className="flex p-5 flex-col   justify-center items-center gap-3 h-[500px] w-4/5">
              ...
              <Link to={'/'} className='px-3 py-2 bg-purple-700 text-white font-bold cursor-pointer text-center rounded-lg w-56'>Continue Shopping</Link>
              <Link to={'/my-orders'} className='px-3 py-2 bg-indigo-700 text-white font-bold cursor-pointer text-center rounded-lg w-56'>My Orders</Link>
              </div>
