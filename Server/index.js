...
const userInteractionRouter=require("./routes/interactionRoute");
const activityRecommendationRouter=require("./routes/activityRecommendationRoute");
...
server.use("/interactions",userInteractionRouter.router);
server.use("/activity-recommendations",activityRecommendationRouter.router);
